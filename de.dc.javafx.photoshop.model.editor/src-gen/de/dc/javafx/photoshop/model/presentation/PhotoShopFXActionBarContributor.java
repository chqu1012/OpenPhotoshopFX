...
/**
 * This is the action bar contributor for the PhotoShopFX model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PhotoShopFXActionBarContributor extends EditingDomainActionBarContributor
		implements ISelectionChangedListener {
	/**
	 * Action to create objects from the PhotoShopFX model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			PhotoShopFXModelWizard wizard = new PhotoShopFXModelWizard();
	 ...
	 * @generated
	 */
	public PhotoShopFXActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("photoshopfx-settings"));
		toolBarManager.add(new Separator("photoshopfx-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ModelEditorPlugin.INSTANCE.getString("_UI_PhotoShopFXEditor_menu"),
				"de.dc.javafx.photoshop.modelMenuID");
