...
/**
 * This is the item provider adapter for a {@link de.dc.javafx.photoshop.model.RectangleFX} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RectangleFXItemProvider extends ShapeFXItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RectangleFXItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RectangleFX"));
	}
	...
	public String getText(Object object) {
		String label = ((RectangleFX) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_RectangleFX_type")
				: getString("_UI_RectangleFX_type") + " " + label;
	}
