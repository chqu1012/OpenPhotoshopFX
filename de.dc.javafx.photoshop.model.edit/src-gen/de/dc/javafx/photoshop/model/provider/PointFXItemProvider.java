...
/**
 * This is the item provider adapter for a {@link de.dc.javafx.photoshop.model.PointFX} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointFXItemProvider extends NodeFXItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PointFXItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PointFX"));
	}
	...
	public String getText(Object object) {
		String label = ((PointFX) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PointFX_type")
				: getString("_UI_PointFX_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PointFX.class)) {
		case PhotoShopFXPackage.POINT_FX__X:
		case PhotoShopFXPackage.POINT_FX__Y:
